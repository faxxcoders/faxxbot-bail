...
async exports.imageToWebp (media) {
...
async exports.videoToWebp (media) {
const tmpFileOut = path.join(tmpdir(), `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.webp`)
...
async exports.writeExifImg (media, metadata) {
...
async exports.writeExifVid (media, metadata) {
...
async exports.writeExif (media, metadata) {
